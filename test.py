...
# as well as the size of the crop after rescaling. If your backbone returns a Tensor,
# featmap_names is expected to be ['0']. More generally, the backbone should return an OrderedDict[Tensor],
